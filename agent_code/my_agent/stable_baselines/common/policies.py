...
def nature_cnn(scaled_images, **kwargs):
    ...
    """
    activ = tf.nn.relu
    layer_1 = activ(conv(scaled_images, 'c1', n_filters=256, filter_size=5, stride=1, init_scale=np.sqrt(2), **kwargs))
    layer_2 = activ(conv(layer_1, 'c2', n_filters=256, filter_size=4, stride=1, init_scale=np.sqrt(2), **kwargs))
